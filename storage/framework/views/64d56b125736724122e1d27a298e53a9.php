                    ...
                    <ul class="list-group list-group-flush" id="recentList">
                        <?php $__empty_1 = true; $__currentLoopData = $recentValidations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                <div>
                                    <h6 class="mb-0">Réservation #<?php echo e($r->id); ?></h6>
                                    <small class="text-muted"><?php echo e(optional($r->validated_at)->format('d/m/Y H:i')); ?></small>
                                </div>
...
<script>
    ...
    const validateUrl = "<?php echo e(route('receptionniste.validate-qr')); ?>";
...
<?php /**PATH C:\laragon\www\hotel-management-system\resources\views/receptionniste/dashboard.blade.php ENDPATH**/ ?>