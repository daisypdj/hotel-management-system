					...
					<div class="row g-0">
						...
						<div class="col-lg-6 order-1">
							<div class="p-4 p-sm-7">
								...
								<!-- Form START -->
								<form method='POST' action="<?php echo e(route('login')); ?>" class="mt-4 text-start">
                                    <?php echo csrf_field(); ?>
									<!-- Email -->
									<div class="mb-3">
...
<?php /**PATH C:\laragon\www\hotel-management-system\resources\views/auth/login.blade.php ENDPATH**/ ?>