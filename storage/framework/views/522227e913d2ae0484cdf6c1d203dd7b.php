        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 mb-4">
                    <h1 class="fs-3"><?php echo e($hotel->nom_hotel); ?></h1>
                    <!-- Location -->
                    <p class="fw-bold mb-0"><i class="bi bi-geo-alt me-2"></i><?php echo e($hotel->ville); ?> </p>
                </div>
            </div>
                ...
                <aside class="col-xl-7 ">
                    <div class="card bg-transparent border">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="mb-0"><?php echo e($duree); ?> days</h6>
                        </div>
                        <!-- Card header END -->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light py-3 px-4 rounded-3">
                                        ...
                                        <h6 class="mb-0"><?php echo e($checkIn); ?></h6>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light py-3 px-4 rounded-3">
                                        ...
                                        <h6 class="mb-0"><?php echo e($checkOut); ?></h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <ul class="list-group list-group-borderless mb-3">
                                <li class="list-group-item px-2 d-flex justify-content-between">
                                    <span class="h6 fw-light mb-0"><?php echo e($room_type->price); ?> XAF x <?php echo e($duree); ?></span>
                                    <span class="h6 fw-light mb-0"><?php echo e($room_type->price * $duree); ?> XAF</span>
                                </li>
                                ...
                                <li class="list-group-item bg-light d-flex justify-content-between rounded-2 px-2 mt-2">
                                    ...
                                    <span class="h5 fw-normal mb-0"><?php echo e($room_type->price * $duree); ?> XAF</span>
                                </li>
                            </ul>

                            <!-- Button -->
                            <form method="post" action="<?php echo e(route('customer.step-final')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <input type="hidden" name="duree" value="<?php echo e($duree); ?>">
                                <input type="hidden" name="price_reservation" value="<?php echo e($room_type->price * $duree); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontoffice.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/Hotel/step-final.blade.php ENDPATH**/ ?>