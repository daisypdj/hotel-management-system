					...
					<div class="row g-0">
						...
						<div class="col-lg-6 order-1">
							<div class="p-4 p-sm-6">
								...
								<p class="mb-0">Are you already a member ?<a href="<?php echo e(route('login')); ?>"> Log in</a></p>

								<!-- Form START -->
                                    <form method="POST" class="mt-4 text-start" action="<?php echo e(route('register')); ?>">
                                        <?php echo csrf_field(); ?>
									<!-- Email -->
                                    <div class="mb-3">
...
</html><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/auth/register.blade.php ENDPATH**/ ?>