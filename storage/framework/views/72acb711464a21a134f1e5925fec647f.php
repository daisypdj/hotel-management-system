		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				...
				<a href="<?php echo e(route('homepage')); ?>">
					<img class="h-40px" src="<?php echo e(asset('assets/images/logo-hotel-light.svg')); ?>" alt="logo">
				</a>
			...
			<div class="col-lg-8 ms-auto">
				<div class="row g-4">
					...
					<div class="col-6 col-md-8">
						...
						<ul class="nav flex-column text-primary-hover">
							<li class="nav-item"><a class="nav-link text-muted" href="<?php echo e(route('register')); ?>">Sign up</a></li>
							<li class="nav-item"><a class="nav-link text-muted" href="<?php echo e(route('login')); ?>">Sign in</a></li>
...
</footer><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/layouts/frontoffice/footer.blade.php ENDPATH**/ ?>