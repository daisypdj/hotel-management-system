                            ...
                            <div class="card-body">
                                ...
                                <form method="post" action="<?php echo e(route('profile.update')); ?>" class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo e(auth()->user()->name); ?>" placeholder="Enter your full name">
                                    </div>

                                    <!-- Email -->
                                    <div class="col-md-6">
                                        <label class="form-label">Email address<span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" name="email" value="<?php echo e(auth()->user()->email); ?>" placeholder="Enter your email id">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backoffice.customer.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/customer/dashboard.blade.php ENDPATH**/ ?>