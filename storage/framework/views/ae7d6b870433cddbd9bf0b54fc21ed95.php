...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendor/glightbox/css/glightbox-1.css')); ?>">
...
<!-- Header START -->
<?php echo $__env->make('layouts.frontoffice.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- Header END -->
...
<!-- =======================
Footer START -->
<?php echo $__env->make('layouts.frontoffice.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- =======================
Footer END -->
...
</html><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/layouts/frontoffice/main.blade.php ENDPATH**/ ?>