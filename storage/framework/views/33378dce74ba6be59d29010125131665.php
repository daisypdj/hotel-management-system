<header class="navbar-light header-sticky">
        ...
        <span class="d-none d-sm-inline-block small">Menu</span>
			...
			<div class="navbar-collapse collapse" id="navbarCategoryCollapse">
				<ul class="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
                    ...
                    <li class="nav-item"> <a class="nav-link active" href="<?php echo e(route('customer.dashboard')); ?>"><i class="fa-solid fa-hotel me-2"></i>Dashboard</a>	</li>
                    <?php endif; ?>
                    <?php if(auth()->user()->role_id==1): ?>
                    <li class="nav-item"> <a class="nav-link active" href="<?php echo e(route('admin.dashboard')); ?>"><i class="fa-solid fa-hotel me-2"></i>Dashboard</a>	</li>
                    <?php endif; ?>
                    <?php if(auth()->user()->role_id==2): ?>
                    <li class="nav-item"> <a class="nav-link active" href="<?php echo e(route('gerant.dashboard')); ?>"><i class="fa-solid fa-hotel me-2"></i>Dashboard</a>	</li>
                    <?php endif; ?>
                ...
                <?php endif; ?>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role_id==3): ?>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('customer.my-reservations.index')); ?>"><i class="fa-solid fa-sign-in me-2"></i>My Reservations</a>	</li>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->guard()->guest()): ?>
                        <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('register')); ?>"><i class="fa-solid fa-sign-in me-2"></i>Register</a>	</li>
                    <?php endif; ?>


					<!-- Nav item Tour -->
                    <?php if(auth()->guard()->guest()): ?>
                    <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('login')); ?>"><i class="fa-solid fa-sign-out me-2"></i>Login</a> </li>
                <?php endif; ?>
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
                ...
                <li class="nav-item ms-3 dropdown">
					...
					<a class="avatar avatar-xs p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
						<img class="avatar-img rounded-circle" src="<?php echo e(asset('assets/images/avatar/06.jpg')); ?>" alt="avatar">
					</a>
						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src="<?php echo e(asset('assets/images/avatar/06.jpg')); ?>" alt="avatar">
								</div>
								<div>
									<a class="h6 mt-2 mt-sm-0" href="#"><?php echo e(auth()->user()->name); ?></a>
	...
	<!-- Logo Nav END -->
</header><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/layouts/frontoffice/header.blade.php ENDPATH**/ ?>