<header class="navbar-light header-sticky">
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
				...
				<li class="nav-item ms-3 dropdown">
					...
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						...
						<li><a class="" href="<?php echo e(route('customer.my-reservations.index')); ?>"><i class="bi bi-bookmark-check fa-fw me-2"></i>My Reservations</a></li>
	...
	<!-- Logo Nav END -->
</header><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/layouts/backoffice/customer/header.blade.php ENDPATH**/ ?>