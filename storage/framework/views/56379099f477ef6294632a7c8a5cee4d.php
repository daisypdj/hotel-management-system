    ...
    <div class="row">
        <div class="col-12 mb-4 mb-sm-5">
            <div class="d-sm-flex justify-content-between align-items-center">
                ...
                <div class="d-grid"><a href="<?php echo e(route('admin.hotels.create')); ?>" class="btn btn-primary-soft mb-0"><i class="bi bi-plus-lg fa-fw"></i>New Hotel</a></div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-warning bg-opacity-10 border border-warning border-opacity-25 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <!-- Digit -->
                    <div>
                        <h4 class="mb-0"><?php echo e($hotelCount); ?></h4>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-primary bg-opacity-10 border border-primary border-opacity-25 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <!-- Digit -->
                    <div>
                        <h4 class="mb-0"><?php echo e($roomCount); ?></h4>
        ...
        <div class="col-md-6 col-xxl-3">
            <div class="card card-body bg-info bg-opacity-10 border border-info border-opacity-25 p-4 h-100">
                <div class="d-flex justify-content-between align-items-center">
                    <!-- Digit -->
                    <div>
                        <h4 class="mb-0"><?php echo e($reservationCount); ?></h4>
                ...
                <div class="row row-cols-xl-7 align-items-lg-center border-bottom g-4 px-2 py-4">
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!-- Info -->
                            <div class="ms-2">
                                <h6 class="mb-0 fw-light"><?php echo e($reservation->name); ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <h6 class="mb-0 fw-normal"><?php echo e($reservation->check_in); ?></h6>
                    </div>

                    <!-- Data item -->
                    <div class="col">
                        <small class="d-block d-lg-none">Au:</small>
                        <h6 class="mb-0 fw-normal"><?php echo e($reservation->check_out); ?></h6>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="avatar avatar-xs flex-shrink-0">
                                <img class="avatar-img rounded-circle" src="<?php echo e(asset($reservation->Room_profile)); ?>" alt="avatar">
                            </div>
                            <!-- Info -->
                            <div class="ms-2">
                                <h6 class="mb-0 fw-light"><?php echo e($reservation->hotel_name); ?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <h6 class="text-success mb-0"><?php echo e($reservation->total_price); ?> XAF</h6>
                    </div>

                    <!-- Data item -->
                    <div class="col">
                        <small class="d-block d-lg-none">Numero Chambre:</small>
                        <div class="badge bg-success bg-opacity-10 text-success"><?php echo e($reservation->room_id); ?></div>
                    </div>
...
<?php echo $__env->make('layouts.backoffice.admin.main-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>