	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xl-10 position-relative mt-n3 mt-xl-n9">
				...
				<!-- Booking from START -->
				<form class="card shadow rounded-3 position-relative p-4 pe-md-5 pb-5 pb-md-4" method="get" action="<?php echo e(route('search')); ?>">
                    <?php echo csrf_field(); ?>
								...
								<div class="flex-grow-1">
									...
									<select name="classe" class="form-select js-choice" data-search-enabled="true">
                                        ...
                                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($classe->title); ?>"><?php echo e($classe->title); ?></option>
...
Featured Hotels START -->
		...
		<div class="row g-4">
            ...
            <?php $__currentLoopData = $arrayHotel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hotel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <!-- Hotel item -->
                <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="card card-img-scale overflow-hidden bg-transparent">
                        ...
                        <div class="card-img-scale-wrapper rounded-3">
                            <!-- Image -->
                            <img style="height: 200px; width: 100%;" src="<?php echo e(asset($hotel->hotel_profile)); ?>" class="card-img" alt="hotel image">
                            <!-- Badge -->
                            <div class="position-absolute bottom-0 start-0 p-3">
                                <div class="badge text-bg-dark fs-6 rounded-pill stretched-link"><i class="bi bi-geo-alt me-2"></i><?php echo e($hotel->ville); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="card-body px-2">
                            <!-- Title -->
                            <h5 class="card-title"><?php echo e($hotel->hotel_name); ?></h5>
                            <!-- Price and rating -->
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="text-success mb-0">$455 <small class="fw-light">/starting at</small> </h6>
                                <h6 class="mb-0"><?php echo e($hotel->star_number); ?><i class="fa-solid fa-star text-warning ms-1"></i></h6>
                            </div>
                        </div>
                    </div>
                    <!-- Card END -->
...
<?php echo $__env->make("layouts.frontoffice.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\hotel-management-system\resources\views/homepage.blade.php ENDPATH**/ ?>