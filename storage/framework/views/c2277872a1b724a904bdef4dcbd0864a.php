    ...
    <div class="container">
        ...
        <?php if(session('payment_error')): ?>
            <div class="alert alert-danger d-flex align-items-center" role="alert">
                <i class="bi bi-exclamation-triangle-fill me-2"></i> <?php echo e(session('payment_error')); ?>
        ...
        <div class="row g-4">
            <!-- Payment methods -->
            <div class="col-lg-8">
                <form method="POST" action="<?php echo e(route('customer.payment.process', $reservation->id)); ?>" id="paymentForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <button type="submit" class="btn btn-primary btn-lg w-100">
                        <i class="bi bi-lock-fill me-2"></i>Payer <?php echo e(number_format($reservation->total_price,0,',',' ')); ?> XAF
                    </button>
                </form>
            </div>
                ...
                <div class="summary-card p-4">
                    ...
                    <ul class="list-group list-group-borderless">
                        ...
                        <li class="list-group-item d-flex justify-content-between px-0">
                            ...
                            <span class="fw-semibold"><?php echo e($reservation->check_in); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0">
                            <span><i class="bi bi-calendar-x me-1"></i>Départ</span>
                            <span class="fw-semibold"><?php echo e($reservation->check_out); ?></span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between px-0 border-top pt-3 mt-2">
                            <span class="fs-6">Total à payer</span>
                            <span class="fs-5 text-primary fw-bold"><?php echo e(number_format($reservation->total_price,0,',',' ')); ?> XAF</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\hotel-management-system\resources\views/customer/payment-select.blade.php ENDPATH**/ ?>