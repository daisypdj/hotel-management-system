...
use App\Http\Controllers\Admin\ReceptionnisteController;
...
use App\Http\Controllers\Receptionniste\DashboardController as ReceptionnisteDashboard;
...
Route::middleware(['auth','admin'])->name('admin.')->prefix('admin')->group(function(){
    ...
    Route::resource('receptionnistes',ReceptionnisteController::class);
...
Route::middleware(['auth','customer'])->name('customer.')->prefix('customer')->group(function(){
    ...
    // Paiement + QR code
    Route::get('paiement/{reservation}',[PaymentController::class,'choose'])->name('payment.choose');
    Route::post('paiement/{reservation}',[PaymentController::class,'process'])->name('payment.process');
    Route::get('paiement/{reservation}/qrcode',[PaymentController::class,'showQr'])->name('payment.qrcode');
    Route::get('paiement/{reservation}/status',[PaymentController::class,'status'])->name('payment.status');
});

Route::middleware(['auth','receptionniste'])->name('receptionniste.')->prefix('receptionniste')->group(function(){

    Route::get('dashboard',[ReceptionnisteDashboard::class,'index'])->name('dashboard');
    Route::post('valider-qrcode',[ReceptionnisteDashboard::class,'validateQr'])->name('validate-qr');
});
