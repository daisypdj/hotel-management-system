            ...
            <ul class="navbar-nav flex-column" id="navbar-sidebar">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse flex-column" id="collapseguest" data-bs-parent="#navbar-sidebar">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('admin.customers.index') }}">user list</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('admin.customers.create') }}">Create user</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse flex-column" id="collapsereception" data-bs-parent="#navbar-sidebar">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('admin.receptionnistes.index') }}">Liste des réceptionnistes</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('admin.receptionnistes.create') }}">Créer une réceptionniste</a></li>
                    </ul>
                </li>
