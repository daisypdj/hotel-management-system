            ...
            <div class="col-md-8 col-lg-6">
                ...
                <div class="card qr-card p-4 p-md-5 text-center">
                            ...
                            <div class="col-sm-8">
                                <ul class="list-group list-group-borderless">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between px-0">
                                        ...
                                        <span class="fw-semibold text-success">{{ number_format($reservation->total_price,0,',',' ') }} XAF</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div id="successState" class="d-none">
                        ...
                        <a href="{{ route('customer.my-reservations.index') }}" class="btn btn-primary">
...
<script>
    new QRCode(document.getElementById("qrcode"), {
        text: "{{ $reservation->qr_token }}",
        width: 220,
        height: 220,
    });

    const statusUrl = "{{ route('customer.payment.status', $reservation->id) }}";
